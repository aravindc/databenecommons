...
public final class TimeUtil {
    ...
    private static boolean isFederalHolidayInUSA(Calendar day) {
        ...
        else if (month == Calendar.MAY && dayOfWeek == Calendar.MONDAY && isLastWeekdayOfTypeInMonth(Calendar.MONDAY, day))
    ...
    private static boolean isHolidayInGermany(Calendar day) {
        ...
        if (month == Calendar.JANUARY && dayOfMonth == 1)
        	...
        	return true; // Christmas
        return false;
        // TODO further German holidays: Karfreitag, Ostermontag, Christi Himmelfahrt, Pfingstmontag
	}
